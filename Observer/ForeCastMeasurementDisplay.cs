namespace Observer
{
    public class ForeCastMeasurementDisplay : IObserver, IDisplayElement
    {
        ...
        public ForeCastMeasurementDisplay(WeatherData weatherData)
        {
        ...
        public void Display()
        {
            Console.WriteLine($"Display from {nameof(ForeCastMeasurementDisplay)}");
