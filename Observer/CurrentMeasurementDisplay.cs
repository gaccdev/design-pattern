namespace Observer
{
    public class CurrentMeasurementDisplay: IObserver, IDisplayElement
    {
        ...
        public CurrentMeasurementDisplay(WeatherData weatherData)
        {
        ...
        public void Display()
        {
            Console.WriteLine($"Display from {nameof(CurrentMeasurementDisplay)}");
